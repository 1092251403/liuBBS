...
<html>
    ...
    <center>
                ...
                <tr>
                    <s:if test="#row.admin!=null">
	                    <td class="left_td" align="top" valign="top">
	                        ...
	                        <br/>
	                        <h5>
	                            <b>姓名：<s:property value="管理员" /></b>
	                            <h5>
	                            <b>昵称：<s:property value="#row.getAdmin().nickName" /></b>
	                        </h5>
	                        </h5>
	                    </td>
	                    <td class="right_td">
       ...
       <s:if test="#session.student != null">
        ...
        <s:if test="#session.admin != null">
            <s:form action="reply!adminReply.action?pid=%{post.id} ">
                <tr>
                    <td style="width:19.5%;"  valign="middle" align="center">
                          <img id="myImg" src="<%=request.getContextPath()%>/images/bbsPhoto.jpg" />
                        <h2>回复：</h2></td><td> <textarea id="context" name="reply.content" ></textarea>  </td>
                </tr>
                <tr>
                    <td></td><td><input type="submit"   value="" style=" border: none; cursor: pointer; width: 74px; height: 31px; background: url('<%=request.getContextPath()%>/images/btn_reply.png') no-repeat;" /></td>
       ...
       <s:if test="#session.student == null && #session.admin == null">
            <s:form action="reply!stuReply.action?pid=%{post.id} ">
                <tr>
                    <td style="width:19.5%;"  valign="middle" align="center">
                          <img id="myImg" src="<%=request.getContextPath()%>/images/bbsPhoto.jpg" />
                        <h2>回复：</h2></td><td> <textarea id="context" name="reply.content" readonly="readonly">请登录后再评论</textarea> </td>
                </tr>
                <tr>
                    <td></td><td><input type="submit"   value="" style=" border: none; cursor: pointer; width: 74px; height: 31px; background: url('<%=request.getContextPath()%>/images/btn_reply.png') no-repeat;" /></td>
                </tr>
