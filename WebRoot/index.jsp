...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            #rank li{ margin:7px;}
            #zuixin{float:left;display:block; margin-left:30px; position:relative; bottom:45px; top:5px; }

            #zuixin li{ margin:7px;}
    ...
    <body>
        ...
        <s:set name="student" value="student" scope="session" ></s:set>
            <div id="banner">	
                ...
                <div id="banner_list">
                    <a href="#" target="_blank"><img src="images/imgs/10794203.jpg" title="西安电子科技大学" alt="西安电子科技大学" /></a>
        ...
        <div class="clear" ></div>
        <div class="btitle">主题推荐</div>
        <div id="zuixin">
            <h3 style="color:red;"> 最新帖子:</h3>
                <ul>
                <s:iterator value="recentlyPosts" id="row" status="st">
                    <li><a href="post!viewDetail.action?pid=<s:property value="id" />"><s:property value="#row.name" />&nbsp; &nbsp;</a>【点击量<s:property value="#row.count" />】</li>
                </s:iterator>
            </ul>
        </div>
        ...
        <div id="huifu">
            <h3 style="color:red;"> 最新回复帖子:</h3>
                <ul>
                <s:iterator value="huifuReply" id="row" status="st">
                    <li><a href="post!viewDetail.action?pid=<s:property value="id" />"><s:property value="#row.Post.name" />&nbsp; &nbsp;</a>【回复时间<s:property value="#row.publishTime"/>】</li>
                </s:iterator>
            </ul>
        </div>
        <div class="clear" ></div>
        ...
        <div class="subBoard">
            <ul>
                <li><a href="http://www.xidian.edu.cn/">西安电子科技大学</a></li>
