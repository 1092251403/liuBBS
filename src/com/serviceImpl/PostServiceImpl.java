...
public class PostServiceImpl implements IPostService {
	...
	@Override
	public int lodepostcount(int id) {
		return dao.lodepostcount("Post",id);
	}

	@Override
	public List<Post> recentlyrankPosts(int size) {
		List<Post> list = dao.query("from Post as p order by p.publishTime desc "); 
        List<Post> result = new ArrayList<Post>();
	...
	@Override
	public List<Reply> huifurankPosts(int size) {
		List<Reply> list = dao.query("from Reply as r order by r.publishTime desc"); 
